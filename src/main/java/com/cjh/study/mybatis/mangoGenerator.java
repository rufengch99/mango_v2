    ...
    public static void main(String[] args) {
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return rb.getString("OutputDirXml") + "/com/cjh/study/mango/mapper/" + rb.getString("className") + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
